...
docker exec -u "$CODEBOX_DOCKER_USER" \
  ...
  -e "CODEBOX_CLAUDE_MARKETPLACES=$CODEBOX_CLAUDE_MARKETPLACES" \
  -e "CODEBOX_CLAUDE_PLUGINS=$CODEBOX_CLAUDE_PLUGINS" \
  -e "CODEBOX_CODE_EXTENSIONS=$CODEBOX_CODE_EXTENSIONS" \
